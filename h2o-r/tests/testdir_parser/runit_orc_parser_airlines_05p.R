...
test.continuous.or.categorical <- function() {
  ...
  airline_part0_csv <- h2o.importFile(locate("bigdata/laptop/parser/orc/000000_0.csv"))

  col.names = c("_col8", "_col16", "_col17", "_col22", "_col29", "_col30")
  col.types = c("enum", "enum", "enum", "enum", "enum", "enum")

  airline_part0_orc <- h2o.importFile(locate("bigdata/laptop/parser/orc/airlines_all.05p/000000_0"),
