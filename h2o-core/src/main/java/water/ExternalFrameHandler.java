...
public class ExternalFrameHandler {
    ...
    public static final byte CONFIRM_READING_DONE = 1;
    public static final byte CONFIRM_WRITING_DONE = 2;
    public static final byte IS_NA = 1;
    public static final byte NOT_NA = 0;
    ...
    private void handleDownloadChunk(SocketChannel sock, AutoBuffer recvAb) throws IOException {
        ...
        ab.putInt(CONFIRM_READING_DONE);
        writeToChannel(ab, sock);
    }
        ...
        do {
            ...
            switch (requestType) {
                ...
                case CLOSE_NEW_CHUNK: // Close new chunks
                    ...
                    outputAb.putInt(CONFIRM_WRITING_DONE);
